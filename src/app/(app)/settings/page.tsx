  ...
  return (
    <div className="p-6 max-w-2xl overflow-y-auto h-full">
      ...
      <div className="space-y-8">
        ...
        <section>
          <h3 className="text-sm font-semibold text-gray-700 mb-1 uppercase tracking-wide">{t.apiKeys}</h3>
          <p className="text-xs text-gray-400 mb-4">{t.apiKeysDesc}</p>
          <ApiKeyInfoCard />
          <div className="space-y-3 mt-4">
            <ApiKeyForm provider="openai" label="OpenAI" placeholder="sk-..." saved={savedProviders.includes('openai')} />
            <ApiKeyForm provider="anthropic" label="Anthropic" placeholder="sk-ant-..." saved={savedProviders.includes('anthropic')} />
            <ApiKeyForm provider="google" label="Google (Gemini)" placeholder="AIza..." saved={savedProviders.includes('google')} />
          </div>
        </section>
