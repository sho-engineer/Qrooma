        ...
        <aside className="w-60 bg-white border-r flex flex-col flex-shrink-0">
          ...
          <div className="flex-1 overflow-y-auto py-2">
            <div className="px-3 mb-1">
              <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider px-2 py-1">{t.rooms}</p>
            </div>
            <SidebarRoomList rooms={rooms ?? []} />
          </div>
          <div className="border-t py-2 px-3 space-y-0.5">
            <a href="/settings" className="flex items-center gap-2 px-2 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 transition-colors">
          ...
          <div className="px-3 pb-3 border-t pt-2">
            ...
            <form action={logout}>
              <button type="submit" className="w-full text-left px-2 py-1.5 text-xs text-gray-500 rounded hover:bg-gray-100 transition-colors">
                {t.logout}
              </button>
            </form>
          </div>
