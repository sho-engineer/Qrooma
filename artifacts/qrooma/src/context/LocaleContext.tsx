...
const ja: Translations = {
  ...
  apiKeyByokBannerDesc:
    "ClarioでAIに議論してもらうには、各AIサービスのAPIキーが必要です。APIキーは、そのサービスを使うための「利用キー」のようなものです。",
  ...
  apiKeySetupLead:
    "ClarioでAIに議論してもらうには、各AIサービスのAPIキーが必要です。APIキーは、そのサービスを使うための「利用キー」のようなものです。一度設定すると、ClarioからそのAIを使って議論を実行できるようになります。",
  apiKeySetupSupportText:
    "「APIキーを取得」を押すと、各サービスの公式ページが開きます。そこでAPIキーを作成し、Clarioに貼り付けてください。",
  apiKeySetupStep1: "使いたいAIサービスを選ぶ",
  apiKeySetupStep2: "「APIキーを取得」を押して公式ページを開く",
  apiKeySetupStep3: "公式ページでAPIキーを作成してコピーする",
  apiKeySetupStep4: "Clarioに戻って貼り付ける",
  getApiKey: "APIキーを取得",
  ...
  landingSubcopy: "Clarioは、ひとりで事業をつくる人のために、候補比較・反証・採用/棄却・残論点整理・次アクション化までを支援するAI Decision Roomです。",
  ...
  landingByokItem4: "Clario の月額プランのみで利用可能",
  landingFooterCta: "今すぐ Clario をはじめる",
  landingNav: "Clario について",
  ...
  landingPositioningSub: "Clario は汎用AIでも、PMツールでも、議事録ツールでもありません。判断を構造化する専用の層です。",
...
const en: Translations = {
  ...
  apiKeyByokBannerDesc:
    "To run discussions in Clario, you need API keys from the AI services you want to use. An API key is like a personal access pass — it lets Clario call that AI on your behalf.",
  ...
  apiKeySetupLead:
    "To run discussions in Clario, you need API keys from the AI services you want to use. An API key is like a personal access pass that lets Clario call that AI on your behalf. Once set, Clario will use it to run discussions automatically.",
  apiKeySetupSupportText:
    'Click "Get API key" to open the provider\'s official page, create a key there, then come back and paste it into Clario.',
  ...
  apiKeySetupStep4: "Come back to Clario and paste it here",
  ...
  landingSubcopy: "Clario helps solo founders and builders compare options, challenge assumptions, decide what to do next, and turn the result into execution-ready briefs and task lists.",
  ...
  landingByokItem4: "Clario charges a flat monthly subscription only",
  landingFooterCta: "Start using Clario for free",
  landingNav: "About Clario",
  ...
  landingPositioningSub: "Clario isn't another chatbot, a PM tool, or a meeting summarizer. It's the decision layer that sits before you build.",
