  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        {/* Demo banner */}
        <div className="mb-4 px-3.5 py-2.5 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-xs font-semibold text-blue-800 mb-0.5">{t.demoModeTitle}</p>
          <p className="text-xs text-blue-700 leading-relaxed">{t.demoModeDesc}</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 text-sm font-medium bg-primary text-primary-foreground rounded-md hover:opacity-90 transition-opacity disabled:opacity-60"
            >
              {isSubmitting
        ...
        {/* API key footnote */}
        <p className="mt-4 text-xs text-center text-muted-foreground leading-relaxed px-1">
          {locale === "ja"
